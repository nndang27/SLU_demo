        ...
        if new_output:
            ...
            while not success and err < 3:  # Retry up to 3 times in case of OpenAI server error.
                try: # http://localhost:8002
                    # API PHOWHISPER  
                    res = requests.post(url = "https://6433-35-221-238-30.ngrok-free.app/asr/phowhisper/small", data = audio_bio)
                    print("TEXT: ",  res.text)
                    transcript = requests.post(url = "https://6433-35-221-238-30.ngrok-free.app/nlu/jointidsf/phobert", params ={"transcript": res.text} )
